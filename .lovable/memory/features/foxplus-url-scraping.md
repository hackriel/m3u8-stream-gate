...
- Recovery: NO usar Quick Retry con misma URL porque `wmsAuthSign` expira/queda 404 tras horas; ID 24 va directo a scraping fresco. Si watchdog detecta arranque colgado sin primer frame, mata el FFmpeg viejo, ignora su close tardío y encola scraping fresco inmediato. Circuit breaker no debe cortar FOX+ URL mientras `always_on` está activo.
