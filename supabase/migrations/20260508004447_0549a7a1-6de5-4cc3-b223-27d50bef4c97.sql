...
ALTER TABLE public.emission_processes ADD CONSTRAINT emission_processes_id_check CHECK (id >= 0 AND id <= 20);
...
VALUES (20, 'srt://obs', 'hls-local', '/video.m3u8', false, 0, 0, 0, 0, 'idle', '')
