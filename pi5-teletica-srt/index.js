 ...
 *    DEVICE_ID          Device ID TDMax exclusivo del canal  (default único Teletica)
...
const DEVICE_ID    = process.env.DEVICE_ID || '2f64f7b8-7d75-4cf4-9a8c-b7e2e99a9004';
...
async function runOnce() {
  ...
  try {
    ...
    log('🔑 URL Teletica obtenida. ffmpeg corre indefinido; solo se re-scrapea si muere o por refresh manual.');
