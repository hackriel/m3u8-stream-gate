#!/usr/bin/env node
/**
 * 🛰️  FOX+ SRT Pusher robusto (Raspberry Pi 5 → VPS:9005)
 *
 * Arquitectura 2026 para estabilidad:
 *   TDMax HLS → FFmpeg Stage A → UDP local:10005 → srt-live-transmit Stage B → VPS:9005
 *
 ...
 *
 * Variables en /etc/foxmas-srt-pusher.env:
...
const CHANNEL_ID = '6a10a6a2350cb5151ab6ca8c';
...
const LOCAL_UDP_PORT = process.env.LOCAL_UDP_PORT || '10005';
